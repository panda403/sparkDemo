...
/**
  ...
  * data format:ID Gender Age registerTime Role region
  * using with ConsumingDataGenerator
  * data like:
  * 1 M 24 2005-11-12 ROLE004 REG003
  * 2 F 36 2008-9-20 ROLE005 REG004
  *
  */
object UserDataGenerator {

  private val FILE_PATH = "/panda/spark/data/sample_user_data.txt"
