...
//    }
    ...
    val broker = "192.168.2.185:9092,192.168.2.186:9092,192.168.2.187:9092"//,192.168.2.186:9092,192.168.2.187:9092
//    val topic = "user-behavior-topic"
    val topic = "20170113"
    //start the message producer thread
    new Thread(new UserBehaviorMsgProducer(broker, topic)).start()
  }
